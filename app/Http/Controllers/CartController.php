    ...
    public function checkout(Request $request){
        ...
        foreach ($cart as $id => $item) {
            ...
            if($item->quantity > $product->product_quantity){
                return redirect('shopCarts')->withErrors('Product'. $product->product_name .'This is no longer in stock as per your request');
                break;
            }
        ...
        return redirect('home')->with('success', 'Order has been sent. ');
