      ...
      <div class="text-center">
        <img src="{{ asset('storage/' . Auth::user()->user_image) }}" class="avatar img-circle img-thumbnail" alt="avatar">
          ...
          <ul class="list-group">
            ...
            <li class="list-group-item text-right"><span class="pull-left"><strong><a href="{{ url('users/'. Auth::user()->id )}}">Personal information</a></strong>
            <li class="list-group-item text-right"><span class="pull-left"><a href="{{ url('order_history') }}">My order</a></span> {{ Auth::user()->orders->count() }}</li>
        ...
        <div class="col-sm-9">
			...
			<div class="tab-content">
				<div id="profile" class="container tab-pane active"><br/>
					...
					<div class="form-group row">
					    <label for="first_name" class="col-sm-4 col-form-label"><h4>Full name</h4></label>
					    <div class="col-sm-8">
					...
					<div class="form-group row">
					    <label for="user_address" class="col-sm-4 col-form-label"><h4>Address</h4></label>
					    <div class="col-sm-8">
