...
@section('content')
  ...
  <div class="shopping-cart">
    ...
    <div class="column-labels">
      <label class="product-image">Picture</label>
      <label class="product-details">Detail</label>
      <label class="product-price">Price</label>
      <label class="product-quantity">Amount</label>
      <label class="product-removal">remove</label>
      <label class="product-line-price">Total amount</label>
    </div>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $("input").change(function(){
        ...
        if(quantity < 1){
          alert('You have entered a negative quantity, please review the cart!');
