    ...
    <div class="row">
      ...
      <div class="text-center">
        <img src="{{ asset('storage/' . Auth::user()->user_image) }}" class="avatar img-circle img-thumbnail" alt="avatar">
          ...
          <ul class="list-group">
            <li class="list-group-item text-muted">Manage <i class="fa fa-dashboard fa-1x"></i></li>
            <li class="list-group-item text-right"><span class="pull-left"><a href="{{ url('users/'. Auth::user()->id )}}">Personal information</a>
            <li class="list-group-item text-right"><span class="pull-left"><strong><a href="{{ url('order_history') }}">My order</a></strong></span></li>
        ...
        <div class="col-sm-9">
			<ul class="nav nav-tabs" role="tablist">
				<li class="nav-item">
					<a href="#profile" class="nav-link active" data-toggle="tab"><i class="fa fa-shopping-basket"></i> Order</a>
				</li>
					  ...
					  <tbody>
					    @foreach( Auth::user()->orders as $order)
						    ...
						    <tr>
						      ...
						      <td>
						      	<button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#rate_for{{ $order->id }}"><i class="fa fa-thumbs-up"></i> Rate</button>
								<!-- The Modal -->
							      ...
							      <div class="modal-dialog modal-lg">
							        <div class="modal-content">
							          ...
							          <div class="modal-body">
							          		<h4>Thank you {{ $order->created_at }} </h4>

                                          Review and rate purchased products (5 stars: Very Good - 1 star: Very Bad)
							          ...
							          <div class="modal-footer">
							          	<button class="btn btn-primary" type="submit" form="_for{{ $order->id }}"><i class="fa fa-paper-plane"></i>Send</button>
